...
export default async function Component() {
  return (
    <StoryCard
      ...
      blob={await importBlob("FvWPgxfsmWHtaUmzuNSte99GMM5Rtiu2CiKMJnZgXbfR")}
      blocks={[await importBlob("7yWSUn7qFfaaRoiPk9UrtTeXDLFULHVpd7RYTLc1t1Vo"), await importBlob("2uDPdSfjM7rcAm5gN12YUFzvs4qPChL9rukXrgsPKwyS")]}
