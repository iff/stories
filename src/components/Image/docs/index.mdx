...
As long as the image is not loaded yet, a placeholder image (generted by [SQIP])
is shown in its place. Once the image is loaded, the placeholder image is faded
away.
