...
export default async function Sample(props: Props) {
  return (
    <Group {...props}>
      ...
      />
      <Image span={[6, 3]} aspectRatio={1} blob={await importImage("9QtiTEJcXCmxdBaQXy8ycRFYZSz5RSycsiW7Edeg5cZP")} />
      <Image
        span={[12, 5]}
        aspectRatio={16 / 7}
        blob={await importImage("EtmcDFTSrxMrwpfC26f6aFWRng9ftRQtvewX4FsiYJ31")}
      />
    </Group>
  );
}
